...
class PokemonPartyConfirmCancelSprite < SpriteWrapper
  ...
  def initialize(text,x,y,narrowbox=false,viewport=nil)
    ...
    if narrowbox
      @bgsprite.addBitmap("desel","Graphics/Pictures/Party/new_icon_cancel_narrow")
      @bgsprite.addBitmap("sel","Graphics/Pictures/Party/new_icon_cancel_narrow_sel")
    else
      @bgsprite.addBitmap("desel","Graphics/Pictures/Party/new_icon_cancel")
      @bgsprite.addBitmap("sel","Graphics/Pictures/Party/new_icon_cancel_sel")
    end
...
class PokemonPartyPanel < SpriteWrapper
  ...
  def initialize(pokemon,index,viewport=nil)
    ...
    self.x = [0,256,0,256,0,256][index]
    self.y = [0,16,96,112,192,208][index]
    self.y = [0,16,101,117,202,218][index]
    @panelbgsprite = ChangelingSprite.new(0,0,viewport)
    @panelbgsprite.z = self.z
    if @active   # Rounded panel
      @panelbgsprite.addBitmap("able","Graphics/Pictures/Party/new_icon_basic_main")
      @panelbgsprite.addBitmap("ablesel","Graphics/Pictures/Party/new_icon_basic_main_sel")
      @panelbgsprite.addBitmap("fainted","Graphics/Pictures/Party/new_icon_basic_main_fainted")
      @panelbgsprite.addBitmap("faintedsel","Graphics/Pictures/Party/new_icon_basic_main_fainted_sel")
      @panelbgsprite.addBitmap("swap","Graphics/Pictures/Party/new_icon_basic_main_sel")
      @panelbgsprite.addBitmap("swapsel","Graphics/Pictures/Party/new_icon_basic_main_sel")
      @panelbgsprite.addBitmap("swapsel2","Graphics/Pictures/Party/new_icon_basic_main_sel")
    else   # Rectangular panel
      #@panelbgsprite.addBitmap("able","Graphics/Pictures/Party/panel_rect")
      @panelbgsprite.addBitmap("able","Graphics/Pictures/Party/new_icon_basic")
      @panelbgsprite.addBitmap("ablesel","Graphics/Pictures/Party/new_icon_basic_sel")
      @panelbgsprite.addBitmap("fainted","Graphics/Pictures/Party/new_icon_basic_fainted")
      @panelbgsprite.addBitmap("faintedsel","Graphics/Pictures/Party/new_icon_basic_fainted_sel")
      @panelbgsprite.addBitmap("swap","Graphics/Pictures/Party/new_icon_basic_sel")
      @panelbgsprite.addBitmap("swapsel","Graphics/Pictures/Party/new_icon_basic_sel")
      @panelbgsprite.addBitmap("swapsel2","Graphics/Pictures/Party/new_icon_basic_sel")
    end
  ...
  def refresh
    ...
    if @pkmnsprite && !@pkmnsprite.disposed?
      @pkmnsprite.x        = self.x+28+5
      @pkmnsprite.y        = self.y+10
    ...
    if @refreshBitmap
      ...
      if !@pokemon.egg?
        ...
        #   "Graphics/Pictures/Party/overlay_lv",120,5,0,0,22,14]])
        pbSetExtraSmallFont(@overlaysprite.bitmap)
        pbDrawTextPositions(@overlaysprite.bitmap,[
           [_INTL("Lv. {1}",@pokemon.level.to_s),124,0,0,basecolor,shadowcolor]
        ])
      end
