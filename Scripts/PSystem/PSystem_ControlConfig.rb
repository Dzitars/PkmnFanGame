...
module Keys
  ...
  def self.defaultControls
    return [
      ControlConfig.new(_INTL("Down"),_INTL("S")),
      ControlConfig.new(_INTL("Left"),_INTL("A")),
      ControlConfig.new(_INTL("Right"),_INTL("D")),
      ControlConfig.new(_INTL("Up"),_INTL("W")),
      ...
      ControlConfig.new(_INTL("Scroll down"),_INTL("V")),
      ControlConfig.new(_INTL("Scroll up"),_INTL("B")),
